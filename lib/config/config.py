...
tf.app.flags.DEFINE_integer('batch_size', 3, "Network batch size during training")
tf.app.flags.DEFINE_integer('max_iters', 40000, "Max iteration")
tf.app.flags.DEFINE_integer('step_size', 2500, "Step size for reducing the learning rate, currently only support one step")
...
tf.app.flags.DEFINE_integer('rpn_batchsize', 3, "Total number of examples")
