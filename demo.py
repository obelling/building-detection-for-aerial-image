...
if __name__ == '__main__':
    ...
    im_names = ['000007.jpg', '000012.jpg', '000014.jpg', '000016.jpg',
                '000019.jpg', '000020.jpg','000000000016.jpg','000000000019.jpg','austin1_8.tiff','austin1_18.tiff',
                'image7.png','ins_img3.jpg','ins_img4.jpg','ins_img5.jpg','ins_img6.jpg']
    for im_name in im_names:
        print('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~')
        print('Demo for data/demo/{}'.format(im_name))
        demo(sess, net, im_name)
        plt.savefig("./testbuilding/"+im_name)
